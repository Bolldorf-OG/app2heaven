...
class CurrentDeedsPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    return ListPage<Deed>(
      ...
      dataStream: dao.getCurrentDeedsStream(),
      iconPath: "assets/deeds/list.png",
      onAdd: () async {
        final deed = await Navigator.pushNamed(context, "/deeds/edit");
        if (deed != null) {
          await dao.insertDeed(deed as DeedsCompanion);
        }
      },
