...
class DecisionEditPage extends StatefulWidget {
  final Decision? decision;

  const DecisionEditPage({Key? key, this.decision}) : super(key: key);
...
class _DecisionEditPageState extends State<DecisionEditPage> {
