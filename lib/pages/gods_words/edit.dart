...
class GodsWordEditPage extends StatefulWidget {
  final GodsWord? godsWord;

  const GodsWordEditPage({Key? key, this.godsWord}) : super(key: key);
...
class _GodsWordEditPageState extends State<GodsWordEditPage> {
