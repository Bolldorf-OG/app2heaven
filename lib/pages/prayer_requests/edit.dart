...
class PrayerRequestEditPage extends StatefulWidget {
  final PrayerRequest? prayerRequest;

  const PrayerRequestEditPage({Key? key, this.prayerRequest}) : super(key: key);
...
class _PrayerRequestEditPageState extends State<PrayerRequestEditPage> {
